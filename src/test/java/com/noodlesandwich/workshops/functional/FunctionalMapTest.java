...
public class FunctionalMapTest {
    ...
    @Test public void
    detects_that_a_map_contains_specific_keys() {
        final FunctionalMap<Character, Integer> map = new FunctionalMap<Character, Integer>()
            .with('o', 1)
            .with('t', 2)
            .with('t', 3)
        ...
        assertThat(map.containsKeys(FunctionalList.of('s', 'f')), is(true));
    }

    @Test public void
    detects_that_a_map_does_not_contain_other_keys() {
        final FunctionalMap<Character, Integer> map = new FunctionalMap<Character, Integer>()
            .with('o', 1)
            .with('t', 2)
            .with('t', 3)
        ...
        assertThat(map.containsKeys(FunctionalList.of('s', 'x', 'f')), is(false));
    }
